{
	...
	"platform:windows" : {
		...
		"commands" : [
			...
			"call PCbuild/build.bat -p x64 --no-tkinter \"/p:PlatformToolset=v142\"",
			...
			"copy externals\\openssl-bin-1.1.1u\\amd64\\libcrypto.lib {buildDir}\\lib",
			"copy externals\\openssl-bin-1.1.1u\\amd64\\libssl.lib {buildDir}\\lib",
			"xcopy /sehyi externals\\openssl-bin-1.1.1u\\amd64\\include\\openssl\\* {buildDir}\\include\\openssl",
